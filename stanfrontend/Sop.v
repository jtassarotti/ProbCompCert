(** Arithmetic and logical operators for Stanlight; a cut down version C/Clight Cop.v *)
...
Proof.
  intros. unfold sem_notbool. destruct (bool_val v t) as [[] | ]; reflexivity.
Qed.
...
Lemma cast_idempotent:
  forall v ty ty' v', sem_cast v ty ty' = Some v' -> sem_cast v' ty' ty' = Some v'.
Proof.
