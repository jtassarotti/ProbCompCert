...
DIRS := lib common $(ARCHDIRS) backend cfrontend driver export cparser stanfrontend
...
STANFRONTEND=Stan.v Stanlight.v Ssemantics.v DenotationalSimulation.v Sparser.v \
  CStan.v \
  CStanCont.v \
